...
- Descriptive information for table entities are in the `descriptions` directory, sometimes as subsets. E.g., resources are described in "resources (physical subset).md" and "resources (extractable subset).md" (the latter is a subset of the former; both are subsets of all resources). Groupings in descriptive files are organizational only.
