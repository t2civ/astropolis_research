# Schema and Notes for operations.tsv
...
- heat — Net waste heat from the operation. Note: in some cases this might be used for facility or district heating or for other purposes.
