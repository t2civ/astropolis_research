...
- **Industrial Metals** — Cu, Ti, Zn, Ni, Sn, Pb, W, Mo, Co, Mn, Cr, etc.; also includes Ag. Ref. production-weighted basket of refined industrial metals (metal content basis). Cu 29, Mn 23, Zn 16, Cr 13.5, Pb 13.5, Ni 3.75, Sn 0.4, Mo 0.35, Ti 0.3, Co 0.24, W 0.1, Ag 0.03, other 0.03. (Simulation note: Ag is treated as an industrial metal rather than a precious metal because this treatment is much less distortional on commodity pricing.)
