...
- rate_ppt — Current run rate in parts-per-thousand of total operation capacity. Operation capacity is the sum of capacities provided by modules in `facilities_modules.tsv` (possibly more than one).
