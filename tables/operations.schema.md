...
- electricity — Net electrical power in MW. Positive for electricity-generating operations; negative for electricity-consuming operations. For Energy group operations, normalized to 1 MW power output. For extraction operations, normalized to -1 MW power usage. For all others, the electrical power per 1 t/h of mass throughput.
