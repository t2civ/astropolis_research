...
- **Drilling Rig (surface)** — [On Earth, "surface" refers to all land area to 100 m depth. Gas, Oil, or both.]
- **Drilling Rig (near-surface)** — [On Earth, "near-surface" refers to continental land and shelf from 0.1–0.5 km depth (below seafloor for shelf), so this drilling operation and below includes offshore.]
- **Drilling Rig (subsurface)** —  [On Earth, "subsurface" refers to continental land and shelf from 0.5–2.0 km depth.]
- **Drilling Rig (deep subsurface)** —  [On Earth, "deep subsurface" refers to continental land and shelf from 2.0–5.0 km depth.]
- **Drilling Rig (extreme subsurface)** —  [On Earth, "extreme subsurface" refers to continental land and shelf from 5.0–12.0 km depth.]
- **Mine (surface)** — [Same area and depth defined for drilling. This module really represents all mining capacity in this strata as a whole, so can change its target ore proportions over time.]
- **Mine (near-surface)** — 
- **Mine (subsurface)** — 
