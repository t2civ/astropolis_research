...
5. For data table construction (.tsv files only), convert item text to CONSTANT_CASE (capitalized letters and digits only separated by underscores). Specific abbreviations to use are listed in individual files.
